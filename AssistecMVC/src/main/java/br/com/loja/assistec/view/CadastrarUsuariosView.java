...
public class CadastrarUsuariosView extends JFrame {
    ...
    public CadastrarUsuariosView(Usuario usuarioSelcionado) {
    	// Definindo os textos dos botões
        setTitle("Cadastro de Usuários");
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        setBounds(100, 100, 450, 300);
        setLocationRelativeTo(null);
        initComponents(usuarioSelcionado);
    }
    ...
    public void addCadastrarUsuariosLiteners(ActionListener listeners) {
